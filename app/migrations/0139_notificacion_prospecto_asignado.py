"""Agrega 'prospecto_asignado' a Notificacion.TIPO_CHOICES para
notificar al vendedor cuando un supervisor le asigna un prospecto.
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0138_prospecto_asignado_por'),
    ]
