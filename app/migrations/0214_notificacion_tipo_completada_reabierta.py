# Generada a mano: makemigrations arrastraba 56 operaciones ajenas a este
# cambio (renombres de indices y AutoField->BigAutoField) que ya estaban
# pendientes en el repo desde antes. Aqui solo se alinea el campo que se toco.
# En MySQL un cambio de choices no altera el esquema; es estado de Django.
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            ], max_length=30, verbose_name='Tipo de Notificación'),
        ),
    ]
