...
def _system_prompt(user, config: AsistenteConfig) -> dict:
    ...
    base = (
        ...
        '   - PRIMER bloque `::: kpis :::` con totales del equipo (4 cards):\n'
        '     1. **Oportunidades** | # | $X MXN\n'
        '     2. **Cotizaciones** | N |\n'
        '     3. **Facturado** | $X MXN |\n'
        '     4. **Cobrado** | $X MXN |\n'
        '   - DESPUÉS `### Por vendedor` con TABLA markdown ordenada por '
        'cobrado descendente:\n'
        '     | Vendedor | Opp | Monto opp | Cotiz | Facturado | Cobrado | Vencidas | Pend. | Completas |\n'
        '   - DESPUÉS 1-2 líneas analíticas: quién destaca (top cobrado), '
        'quién requiere atención (muchas vencidas o cero cobrado).\n\n'
        ...
        '   - Una línea contextual: "X clientes sin movimiento, ordenados por '
        'el monto histórico que nos han dejado (los más valiosos arriba)."\n'
