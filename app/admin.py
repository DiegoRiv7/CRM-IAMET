...
from .models import Cliente, TodoItem, OportunidadProyecto, Volumetria, DetalleVolumetria, Proyecto, Tarea, ProyectoComentario, TareaComentario # Importa TodoItem en lugar de Cotizacion/ItemCotizacion
...
class InstalacionAdmin(admin.ModelAdmin):
    ...
    autocomplete_fields = ('cliente', 'oportunidad', 'proyecto')
