...
def _system_prompt(opp: TodoItem, config: AsistenteConfig, user,
    ...
    base = (
        ...
        'tipo solo "seguimiento" / "tarea" / "llamada" / "correo"), '
        'úsala como **ancla principal** del correo:\n'
        '     · INTERPRETA su intención — no copies su texto literal. '
        'Ejemplo: actividad dice "enviar correo de seguimiento sobre '
        'la última cotización" → tu correo NO debe decir "enviar '
        'correo de seguimiento sobre la última cotización"; debe '
        'redactar ese seguimiento real, mencionando la cotización '
        'específica (su título, monto, fecha) que viste en el contexto.\n'
        '     · Cruza con otras fuentes: si la actividad pide '
        'seguimiento a una cotización, lee la cotización más reciente '
        'y los items reales para mencionarlos. Si pide seguimiento a '
        'un correo, lee el último correo y referéncialo.\n'
        '     · Si la actividad está VENCIDA o el deal lleva semanas/'
        'meses sin movimiento: reconoce el tiempo transcurrido pero '
        '**NUNCA pidas disculpas**. En su lugar usa frases tipo '
        '"agradezco tu paciencia mientras retomamos el tema", '
        '"sé que ha quedado en pausa, vuelvo a ti para…", "vuelvo a '
        'contactarte por…". Tono profesional, sin culpa.\n'
        '     · **Menciona en tu respuesta de chat** (no en el cuerpo '
        'del correo) que anclaste el correo en la actividad: '
        '"Anclé el correo en tu actividad del [fecha]: \'[descripción]\'."\n'
        '   - **Si NO hay actividad sustantiva** (no existe, o es '
        'genérica), sigue el flujo normal: ancla en último correo / '
        'cotización fresca / objeción detectada.\n'
        ...
        'agradece paciencia (no disculpa).\n'
