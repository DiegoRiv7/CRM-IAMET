...
urlpatterns = [
    ...
    path('api/asistente/correos/', views.api_asistente_correos, name='api_asistente_correos'),
    path('api/asistente/correos/estado/', views.api_asistente_correos_estado, name='api_asistente_correos_estado'),
    path('api/asistente/correo/<int:correo_id>/cuerpo/', views.api_asistente_correo_cuerpo, name='api_asistente_correo_cuerpo'),
    path('api/asistente/correo/<int:correo_id>/listo/', views.api_asistente_correo_listo, name='api_asistente_correo_listo'),
    ...
    path('api/asistente/correo/<int:correo_id>/oportunidad-draft/', views.api_asistente_oportunidad_draft, name='api_asistente_oportunidad_draft'),
    path('api/asistente/oportunidad/crear/', views.api_asistente_oportunidad_crear, name='api_asistente_oportunidad_crear'),
    path('api/asistente/correo/<int:correo_id>/oportunidad-update-draft/', views.api_asistente_oportunidad_update_draft, name='api_asistente_oportunidad_update_draft'),
    path('api/asistente/oportunidad/actualizar/', views.api_asistente_oportunidad_update_aplicar, name='api_asistente_oportunidad_update_aplicar'),
    path('api/asistente/oportunidad/<int:opp_id>/seguimiento-draft/', views.api_asistente_seguimiento_draft, name='api_asistente_seguimiento_draft'),
    path('api/asistente/seguimiento/crear/', views.api_asistente_seguimiento_crear, name='api_asistente_seguimiento_crear'),
    ...
    path('api/asistente/reporte/oportunidades/', views.api_asistente_reporte_oportunidades, name='api_asistente_reporte_oportunidades'),
    path('api/asistente/accion/interpretar/', views.api_asistente_accion_interpretar, name='api_asistente_accion_interpretar'),
    # Simulador de correos — banco de pruebas del asistente
    path('simulador-correo/', views.vista_simulador_correo, name='vista_simulador_correo'),
    ...
    path('api/oportunidad/<int:opp_id>/chat/mensaje/<int:msg_id>/fijar/', views.api_chat_mensaje_fijar, name='api_chat_mensaje_fijar'),
    ...
    path('api/mail/firma/', views_mail.api_mail_firma, name='api_mail_firma'),
    path('api/mail/plantillas/', views_mail.api_mail_plantillas, name='api_mail_plantillas'),
    path('api/mail/plantillas/<int:plantilla_id>/eliminar/', views_mail.api_mail_plantilla_eliminar, name='api_mail_plantilla_eliminar'),
    path('api/mail/borradores/', views_mail.api_mail_borradores, name='api_mail_borradores'),
    path('api/mail/borradores/guardar/', views_mail.api_mail_borrador_guardar, name='api_mail_borrador_guardar'),
    path('api/mail/borradores/<int:borrador_id>/', views_mail.api_mail_borrador_detalle, name='api_mail_borrador_detalle'),
    path('api/mail/borradores/<int:borrador_id>/eliminar/', views_mail.api_mail_borrador_eliminar, name='api_mail_borrador_eliminar'),
    path('api/mail/programar/', views_mail.api_mail_programar, name='api_mail_programar'),
    path('api/mail/programados/<int:programado_id>/cancelar/', views_mail.api_mail_programado_cancelar, name='api_mail_programado_cancelar'),
    ...
    path('api/iamet/proyectos/<int:proyecto_id>/programa-obra-pdf/', views_iamet.api_programa_obra_pdf, name='api_iamet_programa_obra_pdf'),
